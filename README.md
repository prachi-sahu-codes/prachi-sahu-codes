<style>
  .icon-container {
    display: flex;
    gap: 10px;
    flex-wrap: wrap; /* Optional: allows wrapping to next line if there are too many icons */
  }
</style>
